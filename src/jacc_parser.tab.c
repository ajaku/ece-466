...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_ELLIPSIS = 19,                  /* ELLIPSIS  */
  YYSYMBOL_TIMESEQ = 20,                   /* TIMESEQ  */
  YYSYMBOL_DIVEQ = 21,                     /* DIVEQ  */
  YYSYMBOL_MODEQ = 22,                     /* MODEQ  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "TOKEOF", "IDENT",
  "CHARLIT", "STRING", "NUMBER", "INDSEL", "PLUSPLUS", "MINUSMINUS", "SHL",
  "SHR", "LTEQ", "GTEQ", "EQEQ", "NOTEQ", "LOGAND", "LOGOR", "ELLIPSIS",
  ...
  "_COMPLEX", "_IMAGINARY", "'+'", "'-'", "'*'", "'/'", "$accept", "exp", YY_NULLPTR
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* exp: NUMBER  */
#line 82 "jacc_parser.y"
            {
    yyval = yyvsp[0];  // Correct: Directly passing token
}
#line 1154 "jacc_parser.tab.c"
    break;

  case 3: /* exp: exp '+' exp  */
#line 85 "jacc_parser.y"
              {
    yyval.token.data.int_type = yyvsp[-2].token.data.int_type + yyvsp[0].token.data.int_type;
    printf("Value: %d\n", yyval.token.data.int_type);
}
#line 1163 "jacc_parser.tab.c"
    break;


#line 1167 "jacc_parser.tab.c"
